<?php
	...
	$datoteka=fopen("download".$ssid.".asm","w");
    	fprintf($datoteka,
            ";<pre>\n".
            ";Generated by Arithmetic Expression Compiler (https://flatassembler.github.io/compiler.html) running in a browser with the user agent:\n". //You should also probably change the URL here to point to where AEC is hosted on your website.
            ";%s\n\n".
            "format PE console\n".
            "entry start\n".
            "\n".
