...
fcomip st1
fstp dword [result]
jna secondOperandOfTheComparisonIsSmallerLabel882019
fld1
jmp endOfTheLessThanComparisonLabel558504
secondOperandOfTheComparisonIsSmallerLabel882019:
fldz
endOfTheLessThanComparisonLabel558504:
fistp dword [result]
mov eax, dword [result]
test eax,eax
je EndWhileLabel331384
;pokazivac:=4*i
finit
...
fcomip st1
fstp dword [result]
jnb secondOperandOfTheComparisonIsGreaterLabel243250
fld1
jmp endOfTheGreaterThanComparisonLabel110124
secondOperandOfTheComparisonIsGreaterLabel243250:
fldz
endOfTheGreaterThanComparisonLabel110124:
fistp dword [result]
mov eax, dword [result]
test eax,eax
je EndWhileLabel605317
...
fcomip st1
fstp dword [result]
jne operandsOfTheEqualityOperatorAreNotEqualLabel433304
fld1
jmp endOfTheEqualityOperatorLabel414071
operandsOfTheEqualityOperatorAreNotEqualLabel433304:
fldz
endOfTheEqualityOperatorLabel414071:
fistp dword [result]
mov eax, dword [result]
test eax,eax
jz ElseLabel230674
...
fcomip st1
fstp dword [result]
jnb secondOperandOfTheComparisonIsGreaterLabel968494
fld1
jmp endOfTheGreaterThanComparisonLabel109099
secondOperandOfTheComparisonIsGreaterLabel968494:
fldz
endOfTheGreaterThanComparisonLabel109099:
fistp dword [result]
mov eax, dword [result]
test eax,eax
jz ElseLabel283927
...
fcomip st1
fstp dword [result]
jna secondOperandOfTheComparisonIsSmallerLabel185514
fld1
jmp endOfTheLessThanComparisonLabel990960
secondOperandOfTheComparisonIsSmallerLabel185514:
fldz
endOfTheLessThanComparisonLabel990960:
fistp dword [result]
mov eax, dword [result]
test eax,eax
je EndWhileLabel22499
...
fcomip st1
fstp dword [result]
jna secondOperandOfTheComparisonIsSmallerLabel867456
fld1
jmp endOfTheLessThanComparisonLabel9377
secondOperandOfTheComparisonIsSmallerLabel867456:
fldz
endOfTheLessThanComparisonLabel9377:
fld dword [gdjeSmoUPrvomNizu]
fld dword [sredinaNiza]
fcomip st1
fstp dword [result]
jne operandsOfTheEqualityOperatorAreNotEqualLabel563427
fld1
jmp endOfTheEqualityOperatorLabel48202
operandsOfTheEqualityOperatorAreNotEqualLabel563427:
fldz
endOfTheEqualityOperatorLabel48202:
fxch
fistp dword [result]
mov eax,dword [result]
fistp dword [result]
...
fcomip st1
fstp dword [result]
jna secondOperandOfTheComparisonIsSmallerLabel371355
fld1
jmp endOfTheLessThanComparisonLabel413404
secondOperandOfTheComparisonIsSmallerLabel371355:
fldz
endOfTheLessThanComparisonLabel413404:
fistp dword [result]
mov eax,dword [result]
fistp dword [result]
...
fcomip st1
fstp dword [result]
jna secondOperandOfTheComparisonIsSmallerLabel809194
fld1
jmp endOfTheLessThanComparisonLabel406419
secondOperandOfTheComparisonIsSmallerLabel809194:
fldz
endOfTheLessThanComparisonLabel406419:
fistp dword [result]
mov eax, dword [result]
test eax,eax
je EndWhileLabel734593
...
fcomip st1
fstp dword [result]
jna secondOperandOfTheComparisonIsSmallerLabel850767
fld1
jmp endOfTheLessThanComparisonLabel236839
secondOperandOfTheComparisonIsSmallerLabel850767:
fldz
endOfTheLessThanComparisonLabel236839:
fistp dword [result]
mov eax, dword [result]
test eax,eax
je EndWhileLabel179874
;pokazivac:=4*i
finit
mov dword [result],0x40800000 ;IEEE754 hex of 4
fld dword [result]
